...
function App() {
  ...
  return (
    <>
    {/* hero section */}
    <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1" id="Hero">
    ...
    <div className="tentang mt-32 py-10" id="tentang">
      ...
      <div className="tools mt-32">
        ...
        <p className="xl:w-2/5 lg:w-2/4 md:w-2/3 sm:w-3/4 w-full text-base/loose opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">Berikut ini tools yang sering saya pakai untuk mengerjakan proyek website</p>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {proyek.tools.map((tool, index) => (
                  <p key={index} className="py-1 px-3 border border-zinc-500 rounded-md font-semibold bg-zinc-600">{tool}</p>
                ))}
              </div>
              <div className="mt-8 text-center">
                <a href="#" className="bg-violet-700 p-3 rounded-lg block birder border-zinc-600 hover:bg-violet-600">Lihat Website</a>
              </div>
            </div>
          </div>
          ))}
    ...
    <div className="kontak mt-32 sm:p-10 p-0" id="kontak">
      ...
      <form action="https://formsubmit.co/alfhiandisaputra01@gmail.com" method="POST" className="bg-zinc-800 p-10 sm:w-fit w-full mx-auto rounded-md" autoComplete="off" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
        <div className="flex flex-col gap-6">
          ...
          <div className="text-center">
            <button type="submit" className="bg-violet-700 p-3 rounded-lg w-full cursor-pointer birder border-zinc-600 hover:bg-violet-600">Kirim Pesan</button>
          </div>
        </div>
      </form>
    </div>
