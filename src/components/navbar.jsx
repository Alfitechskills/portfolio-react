...
const Navbar = () => {
    ...
    return (
        <div className="navbar py-7 flex items-center justify-between">
            <div className="logo">
                <h1 className="text-3xl font-bold bg-white text-black rounded-md px-3 py-1 md:bg-transparent md:text-white"><span className="text-violet-700">Alfi's </span>Portfolio</h1>
            </div>
            ...
            ${active ? "top-0 opacity-100" : "-top-1- opacity-0"}`}>
                <li>
